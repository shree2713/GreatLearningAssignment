package com.greatlearning.game.dice.controller;
...
import com.greatlearning.game.dice.constant.ApplicationConstants;
import com.greatlearning.game.dice.utils.SortUtils;

public class Dice
{
    private static Map<String, Integer> result = new HashMap<String, Integer>();
    private static List<String> previous_State = new ArrayList<String>();
